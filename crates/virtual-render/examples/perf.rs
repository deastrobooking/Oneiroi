...
//!
//! ```sh
//! cargo run --release -p virtual-render --example perf -- --decks 4
//! cargo run --release -p virtual-render --example perf -- --decks 2 --source rgba
//! cargo run --release -p virtual-render --example perf -- --decks 4 --deck-package chromatic-split
//! cargo run --release -p virtual-render --example perf -- --preset halation --master both
//! ```
//!
...
use virtual_hap::{CompressedPlaneFormat, DecodedFrame, DecodedPlane};
