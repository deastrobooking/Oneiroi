...
impl FourDeckCompositor {
        ...
        let deck_layer_pipelines =
            ["fs_deck_a", "fs_deck_b", "fs_deck_c", "fs_deck_d"].map(|entry| {
                create_mixer_pipeline(
                    ...
                    entry,
                    output_format,
                    "virtual-deck-precomposition-pipeline",
                )
            });
    ...
    pub fn set_output_extent(&mut self, device: &wgpu::Device, extent: [u32; 2]) {
        ...
        let input_texture = make_texture("virtual-deck-package-input");
        let input_view = input_texture.create_view(&wgpu::TextureViewDescriptor::default());
        let output_textures = std::array::from_fn(|index| {
            make_texture(match index {
                0 => "virtual-deck-a-package-output",
                1 => "virtual-deck-b-package-output",
                2 => "virtual-deck-c-package-output",
                _ => "virtual-deck-d-package-output",
            })
        });
            ...
            for index in 0..4 {
                ...
                }
                {
                    ...
                    let mut pass = encoder.begin_render_pass(&wgpu::RenderPassDescriptor {
                        label: Some("virtual-deck-precomposition-pass"),
...
fn update_hap_source(
    ...
    frame: &virtual_hap::DecodedFrame,
