...
fn rejected_effect_reload_preserves_the_last_good_pipeline() {
    ...
    let directory =
        std::env::temp_dir().join(format!("virtual-effect-reload-test-{}", std::process::id()));
